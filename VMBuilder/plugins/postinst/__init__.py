...
class postinst(Plugin):
    ...
    def register_options(self):
        ...
        group.add_option('--copy', metavar='PATH', default='', help="Specify PATH to a file listing 'source dest\\n' pair of source file that are on the local machine to be copied into the guest.")
        group.add_option('--execscript', '--exec', metavar='PATH', default='', help="Specify PATH to a script to be executed. In this script you can use 'chroot $1 <cmd>' to execute code in the guest, $1 being the local path of the vm file system being built.")
